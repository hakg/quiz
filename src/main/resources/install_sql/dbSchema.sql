...
(CATEGORY, QUIZ_INFO, INSERT_ID, INSERT_DATE, MODIFY_ID, MODIFY_DATE, `NO`)
VALUES('java', '오버로딩(Overloading)에 대해 설명해주세요. !', 'chang', '2023-07-12', NULL, NULL, 1);
INSERT INTO quiz.QUIZ
(CATEGORY, QUIZ_INFO, INSERT_ID, INSERT_DATE, MODIFY_ID, MODIFY_DATE, `NO`)
VALUES('java', '2번째 문제는 어떻게?', 'chang', '2023-07-18', NULL, NULL, 2);
